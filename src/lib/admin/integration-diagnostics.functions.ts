...
const PROVIDERS: Array<{
  ...
  {
    id: "open_web_china_registry",
    name: "Open-web China registry resolver",
    category: "corporate_registry",
    requiredEnv: ["CHINA_REGISTRY_ENABLED", "FIRECRAWL_API_KEY", "LOVABLE_API_KEY"],
    connectorRunId: "open_web_china_registry",
    evidenceSourcePatterns: ["Open-web registry intelligence%"],
    checklistItemsAffected: [
      "legal_company_existence",
      "chinese_legal_name",
      "unified_social_credit_code",
    ...
    notes: "Firecrawl-backed public-source resolver used when QINCheck/Panda360 keys are unavailable. Open-web registry intelligence is not equivalent to direct official registry API verification.",
    webIntelligenceOnly: true,
  },
  {
