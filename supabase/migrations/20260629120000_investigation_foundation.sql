-- VerifyFirst investigation foundation
-- Adds durable jobs, connector run audit, evidence classifications, report artifacts,
-- webhook replay protection, and refreshable official-source snapshots.
